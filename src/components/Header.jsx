                ...
                <ul>
                  ...
                  <li>
                    ...
                    <ul class="sub-menu">
                      ...
                      <li>
                        <a href="life-at-CountryEdu.html">Life at CountryEdu</a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="countryedu-university.html">
                          CountryEdu University
                        </a>
                      </li>
                      {/* <!--     <li>
                                        <a href="our-Initiative.html">Our Initiative</a>
                                    </li>
                                    <li>
                  ...
                  <li>
                    ...
                    <ul class="sub-menu">
                      ...
                      <li>
                        <a href="iOS-application.html">iOS Application</a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="short-video-ads.html">Short-Video-Ads</a>
                      </li>
                      <li>
                        <a href="robotics-&-ai.html">Robotics & AI</a>
                      </li>
                    </ul>
                  </li>
                  <li>
                    ...
                    <ul class="sub-menu">
                      ...
                      <li>
                        <a href="modernized-it.html">Modernized IT</a>
                      </li>
                      <li>
                        <a href="ai-&-data-service.html">AI & Data Services</a>
                      </li>
                      <li>
                        <a href="security-&-platform.html">
                          Security & Platform
                        </a>
                      </li>
                      <li>
                        <a href="IoT-Services.html">IoT Services</a>
                      </li>
                      <li>
                        <a href="growth-education.html">Growth Education</a>
                      </li>
                    </ul>
                  </li>
                  ...
                  <li>
                    ...
                    <ul class="sub-menu">
                      <li>
                        <a href="real-estate-management-software.html">
                          Real Estate Management Software
                        </a>
                      </li>
                      <li>
                        <a href="fleet-management-system.html">
                          Fleet Management Software
                        </a>
                      </li>
                      <li>
                        <a href="logistic-management-software.html">
                          Logistic Management Software{" "}
                        </a>
                      </li>
                      <li>
                        <a href="gym-management-solutions.html">
                          GYM Management Solution
                        </a>
                      </li>
                      <li>
                        <a href="restaurant-management-software.html">
                          Restaurant Management Software
                        </a>
                      </li>
                      <li>
                        <a href="travel-agency-management-system.html">
                      ...
                      <li>
                        <a href="asset-tracking.html">Asset Tracking</a>
                      </li>
                      <li>
                        <a href="smart-gateways.html">Smart Gateways</a>
                      </li>
                      <li>
                        <a href="industrail-automation.html">
                          Industrial Automation
                        </a>
                      </li>
                      <li>
                        <a href="attendance-system.html">
                          Attendance System (Using RFID, Face Detection)
                        </a>
                      </li>
                    </ul>
                  </li>
                  ...
                  <li>
                    <a href="https://lms.countryedu.com/">RS LMS</a>
                  </li>
                  <li>
